-- NUAM Tax Container System - Complete Database Schema
...
CREATE POLICY "Users can view qualifications they created" ON "qualifications" FOR ALL USING (auth.uid()::text = "userId");
CREATE POLICY "Users can view their own import batches" ON "import_batches" FOR ALL USING (auth.uid()::text = "userId");
